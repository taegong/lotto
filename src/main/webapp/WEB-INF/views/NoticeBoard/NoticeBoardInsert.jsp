...
<div id="main-wrapper">
        ...
        <div class="form-area">
          <form id="articleForm" role="form" action="/article" method="post">
            <br style="clear: both">
            <h3 style="margin-bottom: 25px;">${sessionScope.memberinfo.TB_member_Name }</h3>
             <input class="form-control" id="TB_member_ID" name="TB_member_ID" type="hidden" value="${sessionScope.memberinfo.TB_member_ID }">
				<input class="form-control" id="TB_member_Name" name="TB_member_Name" type="hidden" value="${sessionScope.memberinfo.TB_member_Name }">
            ...
            <div class="boardNum" >
            <select class="boardNum" name="select_box" id="select_box"> 
    ...
    <option value="3">공지게시판</option>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="tb_board_subject" name="tb_board_subject" placeholder="subject" required>
            </div>
            <div class="form-group">
<!--               <textarea class="form-control" id="summernote" name="content" placeholder="content" maxlength="140" rows="7"></textarea> -->
              <textarea class="form-control" id="summernote" name="tb_board_content" placeholder="content" maxlength="140" rows="7"></textarea>
            </div>
            <a  href="#" id="board_inset" name="board_inset">등록</a>
          </form>
        </div>
      </div>
    </div>
  ...
  $("#board_inset").click(function(){
      ...
      alert(contentReplce);
		...
		var objParams = {
				...
				tb_board_type		:$("#select_box option:selected").val(),
				tb_board_content : contentReplce
				};
		
		//ajax 호출
		$.ajax({
			url			:	"/NoticeBoardInsertX",
			dataType	:	"json",
